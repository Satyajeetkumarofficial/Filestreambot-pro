...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN','6802407570:AAFiRtNmzkmgQVkY_vfBuORCVfLY7x6MY9U'))
    name = str(getenv('name', 'filetolinkbot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '60'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002057914265'))
    PORT = int(getenv('PORT', '4348'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '165.22.216.141:4348')) if not ON_HEROKU or getenv('FQDN', '165.22.216.141:4348') else APP_NAME+'.herokuapp.com'
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', 'CinemasNo1'))
